...
1. Existing AI guidance: `AGENTS.md`, `CLAUDE.md`, `.cursor/rules/`, `.cursor/skills/`, `.claude/`, `.codex/`, `.agents/skills/`, `.github/copilot-instructions.md`, other local skills, and `.methodrail/`.
